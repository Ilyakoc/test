...
//         	'filesBehavior'=>'\file\behaviors\FilesBehavior',
    ...
    public function rules()
    {
        ...
        return $this->getRules(array(
            ...
            array('title, link_title, sale_text', 'length', 'max'=>255),
    ...
    { 
        return $this->getScopes([
        	...
        	'cardColumns'=>[
        		'select'=>'`t`.`id`, `t`.`category_id`, title, code, price, sale, new, hit, link_title, notexist, old_price, `main_image`, `main_image_alt`, `main_image_enable`, `hidden`, `sale_text`'
        	],
