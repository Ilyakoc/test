...
window.ecommerce_modules_order_modules_admin_controllers_DefaultController=(function(){
    ...
    _this.init=function(options) {
        ...
        $(document).on("change", o("box") + " " + o("complete"), _this.onChangeCompleted);
	...
	_this.onChangeCompleted=function(e) {
        ...
        e.preventDefault();
		var $t=$(this);
        //var a = parent(e).data("value");
        //console.log( parent(e).data("id"));
        $.ajax({
			type: "POST",
			url: "/admin/order/changeCompleted",
			data: {item: parent(e).data("id"), status: targetValue},
			dataType: "json",
