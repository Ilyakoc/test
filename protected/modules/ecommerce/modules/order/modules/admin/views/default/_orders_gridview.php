...
$columns=[
    ...
    [
        'filter'=>[0=>'В обработке', 1=>'Оплачен и комплектуется', 2=>'Передан в транспортную компанию', 3=>'Заказ выполнен'],
        'header'=>'Статус',
        'name'=>'completed',
        'headerHtmlOptions'=>['style'=>'width:200px;text-align:center;', 'class'=>'bg-info'],
        'htmlOptions'=>['style'=>'text-align:center;vertical-align:middle;'],
        'type'=>'raw',
        'value'=>function($data, $index, $column) {
            return \CHtml::DropDownList('complete','',
                array(0=>'В обработке', 1=>'Оплачен и комплектуется', 2=>'Передан в транспортную компанию', 3=>'Заказ выполнен'),
                array('options' => array($data->completed=>array('selected'=>true)), 'class' => 'status ')
);
        }
    ]
];
