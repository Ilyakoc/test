...
class SettingsForm extends \common\components\base\FormModel
{
    ...
    public function rules()
    {
    	$rules =  array(
            ...
            array('sitename', 'length', 'max'=>40),
            array('slogan, address, sitename, phone, phone2, phone3, email, emailPublic, vkLink, igLink, workingTime, firm_name, counter, hide_news, menu_limit', 'safe'),
    ...
    public function attributeLabels()
    {
        return $this->getAttributeLabels(array(
            ...
            'phone3'=>'Дополнительный телефон',
            'email'=>'Email администратора',
            'emailPublic'=>'Email на сайте',
            'vkLink'=>'Страница в VK',
            'igLink'=>'Страница в Instagram',
