...
Y::js('form_tabs_loader', ';$(".js-form-tabs-loader").hide();$(".js-form-tabs").show();', \CClientScript::POS_READY);
...
?>
<div class="alert alert-default js-form-tabs-loader">Подождите, идет загрузка страницы...</div>
