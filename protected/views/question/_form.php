...
Y::js(
	...
	. 'if(data=="ok"){$("#question-form-div").html("<h2>' . Yii::t('app', 'Your question has been submitted.') . '</h2>");}'
    . 'else{$("#question-form-div").html("<h2>' . Yii::t('app', 'An error occurred while sending the question') . '</h2>");}'
	. '});}}',
